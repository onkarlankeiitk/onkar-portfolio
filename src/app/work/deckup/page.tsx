    ...
    <main style={{ backgroundColor: BG }} className="text-white antialiased">
      ...
      <section className="overflow-hidden" style={{ backgroundColor: BG }}>
        ...
        <div className="relative z-10 flex items-center px-8 md:px-16 pt-3 pb-1">
          <Link href="/#work" className="flex items-center text-zinc-400 hover:text-orange-400 transition-colors">
        ...
        {/* Two-column layout: content left | square banner right */}
        {/* flex-col-reverse = banner appears first on mobile */}
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              {cs.metrics.slice(0, 2).map(m => (
                <div key={m.label}>
                  <p className="text-2xl font-bold mb-0.5" style={{ color: BLUE }}>{m.value}</p>
          ...
          <div className="flex flex-wrap gap-2">
            {cs.team.map(m => (
              <a key={m.name} href={m.url} target="_blank" rel="noreferrer"
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full border border-zinc-200 bg-zinc-50 hover:border-orange-300 hover:bg-orange-50 transition-colors group">
